import{l as e,n as t,o as n,u as r}from"./index-DaezUNSJ.js";import{t as i}from"./AppShell-Dm-ExWX3.js";import{t as a}from"./Navbar-DesYBV1r.js";var o=r(e(),1),s=t();function c(){let e=localStorage.getItem(`tf_token`),t=localStorage.getItem(`tf_user`);if(!e||!t)return!1;try{let t=JSON.parse(atob(e.split(`.`)[1].replace(/-/g,`+`).replace(/_/g,`/`)));return!t.exp||Date.now()<t.exp*1e3}catch{return!0}}function l(){let e=n(),[t,r]=(0,o.useState)(c);return(0,o.useEffect)(()=>{let e=()=>{r(c())};return window.addEventListener(`authChanged`,e),window.addEventListener(`storage`,e),()=>{window.removeEventListener(`authChanged`,e),window.removeEventListener(`storage`,e)}},[]),(0,o.useEffect)(()=>{t&&e(`/dashboard.html`,{replace:!0})},[t,e]),(0,o.useEffect)(()=>{window.supabaseConfig={url:`https://wcqgbleppiaddgfjrnpq.supabase.co`,key:`eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6IndjcWdibGVwcGlhZGRnZmpybnBxIiwicm9sZSI6ImFub24iLCJpYXQiOjE3ODM3Njg0NTAsImV4cCI6MjA5OTM0NDQ1MH0.FAOQMRMjOXrw4YsDf_wv4IhaUiXGoGB1q8Ye-ty2j7c`},window.scrollTo(0,0);let e=document.createElement(`script`);e.src=`https://cdn.jsdelivr.net/npm/@supabase/supabase-js@2/dist/umd/supabase.min.js`,document.head.appendChild(e);let t=document.createElement(`script`);return t.src=`/assets/vault.js`,e.onload=()=>document.body.appendChild(t),e.onerror=()=>document.body.appendChild(t),()=>{e.remove(),t.remove()}},[]),(0,s.jsxs)(s.Fragment,{children:[!t&&(0,s.jsx)(a,{}),(0,s.jsx)(i,{active:`vault`,children:(0,s.jsx)(`div`,{className:t?`vault-session-active`:``,children:(0,s.jsx)(`div`,{dangerouslySetInnerHTML:{__html:`
