import{f as e,l as t,n,o as r}from"./index-fBjjgueK.js";import{t as i}from"./AppShell-Wqa0DZtc.js";import{t as a}from"./Navbar-CPKFJI5T.js";var o=e(t(),1),s=n();function c(){let e=localStorage.getItem(`tf_token`),t=localStorage.getItem(`tf_user`);if(!e||!t)return!1;try{let t=JSON.parse(atob(e.split(`.`)[1].replace(/-/g,`+`).replace(/_/g,`/`)));return!t.exp||Date.now()<t.exp*1e3}catch{return!0}}function l(){let e=r(),[t,n]=(0,o.useState)(c);return(0,o.useEffect)(()=>{let e=()=>{n(c())};return window.addEventListener(`authChanged`,e),window.addEventListener(`storage`,e),()=>{window.removeEventListener(`authChanged`,e),window.removeEventListener(`storage`,e)}},[]),(0,o.useEffect)(()=>{t&&e(`/dashboard.html`,{replace:!0})},[t,e]),(0,o.useEffect)(()=>{window.supabaseConfig={url:`https://wcqgbleppiaddgfjrnpq.supabase.co`,key:`eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6IndjcWdibGVwcGlhZGRnZmpybnBxIiwicm9sZSI6ImFub24iLCJpYXQiOjE3ODM3Njg0NTAsImV4cCI6MjA5OTM0NDQ1MH0.FAOQMRMjOXrw4YsDf_wv4IhaUiXGoGB1q8Ye-ty2j7c`},window.scrollTo(0,0);let e=document.createElement(`script`);e.src=`https://cdn.jsdelivr.net/npm/@supabase/supabase-js@2/dist/umd/supabase.min.js`,document.head.appendChild(e);let t=document.createElement(`script`);t.src=`/assets/vault.js`,e.onload=()=>document.body.appendChild(t),e.onerror=()=>document.body.appendChild(t);let n=document.createElement(`link`);return n.rel=`stylesheet`,n.href=`/assets/vault.css`,document.head.appendChild(n),()=>{e.remove(),t.remove(),n.remove()}},[]),(0,s.jsxs)(s.Fragment,{children:[!t&&(0,s.jsx)(a,{}),(0,s.jsx)(i,{active:`vault`,children:(0,s.jsx)(`div`,{className:t?`vault-session-active`:``,children:(0,s.jsx)(`div`,{dangerouslySetInnerHTML:{__html:`
