import{c as e,l as t,n,o as r}from"./index-tZfP84dP.js";import{t as i}from"./AppShell-U0cH0xLv.js";import{t as a}from"./Navbar-CxH_GN9c.js";var o=t(e(),1),s=n();function c(){let e=localStorage.getItem(`tf_token`),t=localStorage.getItem(`tf_user`);if(!e||!t)return!1;try{let t=JSON.parse(atob(e.split(`.`)[1].replace(/-/g,`+`).replace(/_/g,`/`)));return!t.exp||Date.now()<t.exp*1e3}catch{return!0}}function l(){let e=r(),[t,n]=(0,o.useState)(c);return(0,o.useEffect)(()=>{let e=()=>{n(c())};return window.addEventListener(`authChanged`,e),window.addEventListener(`storage`,e),()=>{window.removeEventListener(`authChanged`,e),window.removeEventListener(`storage`,e)}},[]),(0,o.useEffect)(()=>{t&&e(`/dashboard.html`,{replace:!0})},[t,e]),(0,o.useEffect)(()=>{window.supabaseConfig={url:void 0,key:void 0},window.scrollTo(0,0);let e=document.createElement(`script`);e.src=`/assets/vault.js`,document.body.appendChild(e);let t=document.createElement(`link`);return t.rel=`stylesheet`,t.href=`/assets/vault.css`,document.head.appendChild(t),()=>{e.remove(),t.remove()}},[]),(0,s.jsxs)(s.Fragment,{children:[!t&&(0,s.jsx)(a,{}),(0,s.jsx)(i,{active:`vault`,children:(0,s.jsx)(`div`,{className:t?`vault-session-active`:``,children:(0,s.jsx)(`div`,{dangerouslySetInnerHTML:{__html:`
