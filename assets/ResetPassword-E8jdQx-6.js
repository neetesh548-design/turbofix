import{l as e,n as t,u as n}from"./index-Cj8mt9yd.js";import{t as r}from"./MainLayout-BReoIeOP.js";var i=n(e(),1),a=t();function o(){return(0,i.useEffect)(()=>{window.scrollTo(0,0);let e=document.createElement(`script`);e.src=`/assets/vault.js`,document.body.appendChild(e);let t=document.createElement(`link`);return t.rel=`stylesheet`,t.href=`/assets/vault.css`,document.head.appendChild(t),()=>{e.remove(),t.remove()}},[]),(0,a.jsx)(r,{children:(0,a.jsx)(`div`,{dangerouslySetInnerHTML:{__html:`
