...
export const contentByLanguage = {
  en: {
    ...
    recordsOutcomes: [
      ...
      { title: 'Exportable Data Backup', body: 'Export complete plant data in CSV, JSON, and Excel format.' },
    ],
    ...
    contactTitle: 'Book a plant walkthrough.',
    contactBody: 'We will map TurboFix to one representative machine and show the workflow live.',
    contactPoints: ['Review sample records', 'Map one critical machine', 'Test the QR breakdown flow'],
    ...
    submit: 'Book walkthrough',
    formNote: 'We use these details only to schedule your walkthrough.',
    successTitle: 'Walkthrough request created',
    successBody: 'A WhatsApp message opened with your details. Send it to confirm the appointment.',
  },
  hi: {
