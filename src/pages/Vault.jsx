...
<div class="vault-topbar">
  <a href="#top" class="brand">
    ...
    <span class="brand-name"><span class="brand-turbo">TURBO</span><span class="brand-fix">FIX</span></span> <span style="font-size: 1.1rem; font-weight: 500; color: var(--slate); margin-left: 6px;">Document Vault</span>
  </a>
