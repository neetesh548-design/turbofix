  ...
  return (
    <AppShell active="inventory">
      <div className="decision-page md-dashboard inv-page" data-role={role} data-testid="inventory-page">
        ...
        {/* Inventory Warehouse Connection Banner */}
        <div className="stitch-glass-tile overflow-hidden mb-6 flex flex-col md:flex-row items-center gap-6 p-4 sm:p-5 relative group border border-emerald-500/30">
          <div className="w-full md:w-1/3 h-44 rounded-xl overflow-hidden relative flex-shrink-0">
            <img
              ...
              alt="Smart Spare Parts Store & Inventory Control"
          ...
          <div className="flex-1 space-y-2">
            ...
            <p className="text-xs text-slate-300 leading-relaxed">
              Track critical motors, bearings, and consumables with automatic minimum-stock alerts and one-click purchase order approvals.
            </p>
          </div>
        </div>
