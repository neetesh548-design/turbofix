...
export default function Footer() {
  ...
  const copy = {
    en: {
      ...
      note: 'TurboFix supports the workflow and decision layer. Analytics stays underneath, and authorized plant personnel remain responsible for safety, approval, and execution.',
    ...
    hi: {
      ...
      note: 'TurboFix मेंटेनेंस के workflow और decision layer में सहायता करता है। Analytics नीचे रहता है, और सुरक्षा, मंजूरी और काम की जिम्मेदारी अधिकृत प्लांट टीम की रहती है।',
    ...
    mr: {
      ...
      note: 'TurboFix मेंटेनन्सच्या workflow आणि decision layer ला सहाय्य करते. Analytics खाली राहते, आणि सुरक्षा, मंजुरी आणि अंमलबजावणीची जबाबदारी अधिकृत प्लांट टीमची राहते.',
