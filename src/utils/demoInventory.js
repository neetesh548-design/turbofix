/* ===========================================================
   ...
   render actually appears at least once, while the total stock value
   lands around ₹2 lakhs for presentation use:
...
export const DEMO_PARTS = [
  ...
  {
    id: 'p-13',
    name: 'Servo Drive Module SDM-750',
    part_number: 'SDM-750',
    associated_machine: 'CNC Milling Center #01',
    machine_priority: 'Critical',
    lead_time_days: 18,
    ...
    supplier: 'Siemens Industrial',
    location: 'Bin A-09',
    last_used_date: isoDate(-11),
    auto_order: true,
    store_manager_note: 'High value drive electronics for spindle control.',
  },
  {
    id: 'p-14',
    name: 'Hydraulic Valve Cartridge HVC-40',
    part_number: 'HVC-40',
    associated_machine: '50-Ton Hydraulic Press',
    machine_priority: 'High',
    lead_time_days: 12,
    ...
    supplier: 'Bosch Rexroth',
    location: 'Bin H-06',
    last_used_date: isoDate(-14),
    store_manager_note: 'Critical valve body for hydraulic response.',
  },
  {
    id: 'p-15',
    name: 'Machine Vision Camera MVC-2K',
    part_number: 'MVC-2K',
    associated_machine: 'Main Automated Conveyor',
    machine_priority: 'High',
    lead_time_days: 16,
    ...
    supplier: 'Omron Automation',
    location: 'Bin E-11',
    last_used_date: isoDate(-22),
    auto_order: true,
    store_manager_note: 'Used for line inspection and defect detection.',
  },
  {
    id: 'p-16',
    name: 'Industrial Fan Motor 3HP',
    part_number: 'FAN-3HP',
    associated_machine: 'Air Compressor Unit #02',
    machine_priority: 'Medium',
    lead_time_days: 8,
    ...
    supplier: 'Fenner Drives',
    location: 'Bin B-21',
    last_used_date: isoDate(-7),
    store_manager_note: 'Fan motor kept for compressor cooling assembly.',
  },
];
...
export const DEMO_CONSUMABLES = [
  ...
  {
    id: 'c-5',
    name: 'Degreasing Solvent Drum',
    part_number: 'CLN-SOLV-20L',
    associated_machine: 'Plant General',
    machine_priority: 'Low',
    lead_time_days: 3,
    stock_qty: 18,
    ...
    supplier: 'Ador Welding',
    location: 'Shelf G-09',
    last_used_date: isoDate(-4),
    store_manager_note: 'Used for cleaning and prep during service shutdowns.',
  },
  {
    id: 'c-6',
    name: 'Cutting Fluid Concentrate',
    part_number: 'CUT-FLD-5L',
    associated_machine: 'CNC Milling Center #01',
    machine_priority: 'Medium',
    lead_time_days: 4,
    stock_qty: 22,
    ...
    location: 'Shelf G-05',
    last_used_date: isoDate(-2),
    store_manager_note: 'Added for tool life and chip evacuation.',
  },
  {
    id: 'c-7',
    name: 'Safety Nitrile Gloves Pack',
    part_number: 'SAF-GLOV-L',
    associated_machine: 'Plant General',
    machine_priority: 'Low',
    lead_time_days: 2,
    stock_qty: 30,
    ...
    location: 'Shelf G-11',
    last_used_date: isoDate(-1),
    store_manager_note: 'Frequent issue item for shop floor teams.',
  },
  {
    id: 'c-8',
    name: 'Hydraulic Hose Protection Sleeve',
    part_number: 'HPS-50',
    associated_machine: '50-Ton Hydraulic Press',
    machine_priority: 'Critical',
    lead_time_days: 6,
    ...
    location: 'Shelf G-14',
    last_used_date: isoDate(-3),
    store_manager_note: 'Protects hose assemblies during high-pressure service.',
  },
];
...
export const DEMO_PURCHASE_ORDERS = [
  ...
  },
  {
    ...
    priority: 'Critical',
    requested_by: 'R. Sharma (Stores)',
    created_date: isoDate(-3),
    expected_delivery_date: isoDate(18),
    total_amount: 55500,
    items: [
      {
        name: 'Servo Drive Module SDM-750',
  ...
  },
  {
    ...
    priority: 'High',
    requested_by: 'A. Verma (Maintenance)',
    created_date: isoDate(-7),
    expected_delivery_date: isoDate(10),
    total_amount: 37600,
    items: [
      {
        name: 'Hydraulic Valve Cartridge HVC-40',
  ...
  },
  {
    ...
    priority: 'High',
    requested_by: 'R. Sharma (Stores)',
    created_date: isoDate(-12),
    expected_delivery_date: isoDate(6),
    total_amount: 48000,
    items: [
      {
        name: 'Machine Vision Camera MVC-2K',
  ...
  },
  {
    ...
    priority: 'Medium',
    requested_by: 'A. Verma (Maintenance)',
    created_date: isoDate(-20),
    expected_delivery_date: isoDate(-8),
    total_amount: 12600,
    items: [
      {
        name: 'Cutting Fluid Concentrate',
