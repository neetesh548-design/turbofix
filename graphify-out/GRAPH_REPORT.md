...
Cohesion: 0.07
Nodes (24): App(), Assistant, Dashboard, Home, Inventory, Kaizen, Login, Machines (+16 more)
...
Cohesion: 0.08
Nodes (5): EscalationThresholdRequest, Admin router — internal TurboFix platform operations console., upsert_escalation_threshold(), wacrm_send_message(), WaCRMSendMessage
...
Cohesion: 0.09
Nodes (38): CustomKpiRepository, MachineRepository, Dashboard(), fetchRoleSources(), fetchWithTimeout(), ROLE_HEADINGS, KAIZEN_CATEGORIES, LEAN_WASTES (+30 more)
...
## Knowledge Gaps
- **723 isolated node(s):** `machine`, `plantSuggestions`, `machineSuggestions`, `ROLE_HEADINGS`, `WORKSPACE_TABS` (+718 more)
